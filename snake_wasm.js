...
const __widl_f_restore_CanvasRenderingContext2D_target = CanvasRenderingContext2D.prototype.restore || function() {
    throw new Error(`wasm-bindgen: CanvasRenderingContext2D.prototype.restore does not exist`);
};

export function __widl_f_restore_CanvasRenderingContext2D(arg0) {
    __widl_f_restore_CanvasRenderingContext2D_target.call(getObject(arg0));
}

const __widl_f_save_CanvasRenderingContext2D_target = CanvasRenderingContext2D.prototype.save || function() {
    throw new Error(`wasm-bindgen: CanvasRenderingContext2D.prototype.save does not exist`);
};

export function __widl_f_save_CanvasRenderingContext2D(arg0) {
    __widl_f_save_CanvasRenderingContext2D_target.call(getObject(arg0));
}
